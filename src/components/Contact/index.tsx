    ...
    <>
      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="flex gap-4">
                    ...
                    Address: Pallipuram, Parudur, Kerala 679305
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-15 bg-white rounded-xl shadow-1 p-4 sm:p-7.5">
            <div className="py-5 px-4 sm:px-7.5 border-b border-gray-3 mb-7.5">
              <p className="font-medium text-xl text-dark">
                Our Location
              </p>
            </div>
            ...
            <div className="w-full h-96 rounded-lg overflow-hidden">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.610535745076!2d76.10694067480588!3d10.841087489311606!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7c7dc1552c4bd%3A0x515d9430eb89d20f!2sR4R5%2BCRJ%2C%20Pallipuram%2C%20Parudur%2C%20Kerala%20679305!5e0!3m2!1sen!2sin!4v1762514154140!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen 
