...
const ShopWithoutSidebar = () => {
  ...
  return (
    <>
      <Breadcrumb
        title={selectedCategory === "All Products" ? "Explore All Products" : selectedCategory}
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="w-full">
              ...
              {categoryParam && (
                <div className="mb-6 p-4 bg-white rounded-lg shadow-1">
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-dark-4">Showing products in: </span>
                      <span className="font-semibold text-dark capitalize">{selectedCategory}</span>
                      <span className="text-dark-4 ml-2">
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zM5.707 5.707a1 1 0 0 0 0 1.414L6.586 8l-.879.879a1 1 0 1 0 1.414 1.414L8 9.414l.879.879a1 1 0 0 0 1.414-1.414L9.414 8l.879-.879a1 1 0 0 0-1.414-1.414L8 6.586l-.879-.879a1 1 0 0 0-1.414 0z"
                          fill=""
                        />
                      </svg>
                      Clear Filter
