...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  const hasOffer = item.offer && parseFloat(item.offer) > 0;
  ...
  return (
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex flex-col sm:flex-row">
        {/* Image Section */}
        <div className="shadow-list relative overflow-hidden flex items-center justify-center max-w-[270px] w-full p-4">
          {/* Offer Badge */}
          {hasOffer && (
          ...
          <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
            ...
            <button
              ...
              className="inline-flex font-medium text-custom-sm py-1.5 px-5 rounded-[5px] bg-blue text-white hover:bg-blue-dark transition"
            >
              Add to Cart
            </button>
          </div>
        ...
        {/* Content Section */}
        <div className="flex-1 flex flex-col justify-center py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12 gap-3">
          {/* Category */}
          ...
          {/* Title */}
          <h3 className="font-medium text-dark hover:text-blue transition text-lg line-clamp-2">
