...
const SingleItem = ({ item }) => {
  const [quantity, setQuantity] = useState(item.quantity || 30); // fallback to 30
    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5">
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-md border border-gray-3">
          <button
            ...
            className="flex items-center justify-center w-11.5 h-11.5 text-dark hover:text-blue disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
            <svg
          ...
          <button
            ...
            className="flex items-center justify-center w-11.5 h-11.5 text-dark hover:text-blue transition"
          >
            <svg
              className="fill-current"
              width="20"
      ...
      <div className="min-w-[50px] flex justify-end">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-2 border border-gray-3 text-dark hover:bg-red-light-6 hover:border-red-light-4 hover:text-red transition"
        >
          <svg
            className="fill-current"
            width="22"
